...
<style>
    ...
    .book-spread:hover {
        ...
        box-shadow: 0 70px 140px rgba(0, 0, 0, 0.55),
    ...
    :global(.turning-page.turn-right-to-left) {
        ...
        background-image: linear-gradient(to right, rgba(0, 0, 0, 0.1) 0%, transparent 5%),
    ...
    :global(.turning-page.turn-left-to-right) {
        ...
        /* Add gradient overlay for realistic page curl shadow */
        background-image: linear-gradient(to left, rgba(0, 0, 0, 0.1) 0%, transparent 5%),
        linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(248, 250, 252, 0.98) 100%);
    }

    :global(.dark) :global(.turning-page.turn-right-to-left),
    :global(.dark) :global(.turning-page.turn-left-to-right) {
        background-image: linear-gradient(to right, rgba(0, 0, 0, 0.2) 0%, transparent 5%),
